...
class RestApi extends RouteBuilder {
    ...
    public void configure() {
        ...
        rest("/certificados").description("Detalle de un expediente")
        .get("/{matricula}").description("Obtiene el certificado de obligaciones financieras de INURBE")
    		.produces("application/pdf")
    		.type(CertificadoInputData.class)
    		.route().routeId("inurbe-certificado-api")
